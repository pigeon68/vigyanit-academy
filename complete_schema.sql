-- Complete database schema for Vigyanit Academy

-- Create profiles table with plain_password
...
-- Create parents table with all fields
...
ALTER TABLE parents ADD COLUMN IF NOT EXISTS occupation TEXT;
ALTER TABLE parents ADD COLUMN IF NOT EXISTS referral_source TEXT;
ALTER TABLE students ADD COLUMN IF NOT EXISTS date_of_birth DATE;
ALTER TABLE students ADD COLUMN IF NOT EXISTS school_name TEXT;
ALTER TABLE students ADD COLUMN IF NOT EXISTS selected_subject TEXT;
ALTER TABLE students ADD COLUMN IF NOT EXISTS selected_course TEXT;
ALTER TABLE students ADD COLUMN IF NOT EXISTS preferred_class TEXT;
ALTER TABLE students ADD COLUMN IF NOT EXISTS payment_method TEXT;
ALTER TABLE students ADD COLUMN IF NOT EXISTS payment_status TEXT;
ALTER TABLE teachers ADD COLUMN IF NOT EXISTS id UUID DEFAULT gen_random_uuid();

-- Update existing admin profile with plain_password
UPDATE profiles 
SET plain_password = 'VigyanIT#2025@Secure!' 
WHERE email = 'office@vigyanitacademy.com';
