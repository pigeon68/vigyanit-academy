                        ...
                        <nav className="max-w-[1400px] mx-auto px-6 lg:px-12">
                          <div className="flex items-center justify-between h-16 sm:h-20 lg:h-24">
                            ...
                            <button
                              ...
                              className="lg:hidden w-10 h-10 flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-[#c9a962] rounded-sm relative"
                            ...
                            >
                              <div className="relative w-6 h-6">
                                ...
                                <span
                                  className={`absolute left-0 w-6 h-px bg-[#1a1a1a] transition-all duration-300 ${
                                    isMobileMenuOpen ? "opacity-0 top-1/2 -translate-y-1/2" : "top-1/2 -translate-y-1/2"
                                  }`}
                                />
                                <span
                                  className={`absolute left-0 w-6 h-px bg-[#1a1a1a] transition-all duration-300 ${
